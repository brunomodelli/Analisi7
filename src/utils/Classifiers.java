...
public class Classifiers {
	...
	private static float controlExpected(float expected, float avgShotsUnder, float avgShotsOver, float dist)
	{
	...
	public static float shots(ExtendedFixture f, ArrayList<ExtendedFixture> all) {
		...
		controlExpected(expected, avgShotsUnder, avgShotsOver, dist);
